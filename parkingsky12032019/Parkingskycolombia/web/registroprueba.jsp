...
<header>
 ...
 <a href="https://www.instagram.com/?hl=es-la"> <div id="icono3" class="redes"></div></a>
  ...
  <a href="RegisUsuario.jsp"><li class="botones">Registrar Usuario</li></a>
      ...
      <td> <label >Nombre</label>
      <input name="nombre"  type="text"  placeholder="Nombre Usuario" pattern="[A-Za-z]+" ></td>
      <td><label >Apellido</label>
      <input name="apellido"  type="text"  placeholder="Apellido Usuario" pattern="[A-Za-z0-9]+" ></td>
      <td>
...
<input type="text" name="documento"  placeholder="Ingresa  Número De Identeficaión De El Usuario" pattern="[0-9]+"></td>
   <td>
    <label >Correo</label>
